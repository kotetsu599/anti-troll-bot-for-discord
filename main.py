...
log_channel_id = 1271420913723899955  #認証機能を使うときに必要です。新たにボットとあなた以外アクセスできないチャンネルを作成して下さい。
role_id = 1271420990664085556  #認証時につけるロールのid
verify_channel_id = 1271423789577539645  # 認証に使うチャンネルid (この認証は、そのちゃんねるで.verifyと打つとできます。)
bot_token = "" # botのトークン
